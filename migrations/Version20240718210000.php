 ...
 */
final class Version20240718210000 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE session');
        $this->addSql('CREATE TABLE session (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, coach_id INTEGER NOT NULL, student_id INTEGER DEFAULT NULL, start_date_time DATETIME NOT NULL, status BOOLEAN DEFAULT FALSE, satisfaction INTEGER DEFAULT NULL, notes CLOB DEFAULT NULL, CONSTRAINT FK_D044D5D43C105691 FOREIGN KEY (coach_id) REFERENCES coach (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D044D5D4CB944F1A FOREIGN KEY (student_id) REFERENCES student (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
