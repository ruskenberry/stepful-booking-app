 ...
 */
final class Version20240718210953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__session AS SELECT id, coach_id, student_id, start_date_time, satisfaction, notes FROM session');
        ...
        $this->addSql('INSERT INTO session (id, coach_id, student_id, start_date_time, satisfaction, notes) SELECT id, coach_id, student_id, start_date_time, satisfaction, notes FROM __temp__session');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session ADD COLUMN status BOOLEAN NOT NULL');
    }
}
